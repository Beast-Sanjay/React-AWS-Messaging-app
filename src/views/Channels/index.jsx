  ...
  return (
    ...
    >
      <Cell gridArea="heading">
        ...
        >
          {activeView === 'Moderator' && moderatedChannel.Name} F13 Hobbies Community
      ...
      <Cell gridArea="main" style={{ height: 'calc(100vh - 3rem)' }}>
        ...
        {activeChannel.ChannelArn &&
          ...
          <div className="placeholder" style={{alignItems:'center'}} >Welcome  To <br/> F13 Hobbies Community</div>
        )}
      </Cell>
    </Grid>
  );
